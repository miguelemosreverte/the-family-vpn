...
// SetTemplatesDir sets the directory for loading templates from disk (enables hot reload).
func (s *Server) SetTemplatesDir(dir string) {
	s.templatesDir = dir
}
...
// loadIndexHTML assembles the index page from template files.
